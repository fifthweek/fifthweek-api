...
//// Generated on 10/09/2015 18:05:33 (UTC)
//// Mapped solution in 10.65s
...
namespace Fifthweek.Api.Aggregations.Queries
{
    ...
    public partial class UserState 
    {
        public override string ToString()
        {
            return string.Format("UserState({0}, {1}, {2}, {3})", this.AccessSignatures == null ? "null" : this.AccessSignatures.ToString(), this.AccountSettings == null ? "null" : this.AccountSettings.ToString(), this.Blog == null ? "null" : this.Blog.ToString(), this.Subscriptions == null ? "null" : this.Subscriptions.ToString());
        }
