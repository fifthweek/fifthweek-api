namespace Fifthweek.Api.Blogs.Tests
{
    ...
    [TestClass]
    public class GetBlogChannelsAndCollectionsDbStatementTests : PersistenceTestsBase
    {
        ...
        private GetBlogChannelsAndCollectionsDbStatement target;

        [TestInitialize]
        public void TestInitialize()
        {
            this.target = new GetBlogChannelsAndCollectionsDbStatement(new Mock<IFifthweekDbConnectionFactory>(MockBehavior.Strict).Object);
        }
        ...
        public async Task WhenGettingBlog_ItShouldReturnTheResult()
        {
            ...
            {
                this.target = new GetBlogChannelsAndCollectionsDbStatement(testDatabase);
                ...
                var collection1 = channel2.Collections.Single(v => v.CollectionId.Equals(CollectionId1));
                var collection2 = channel3.Collections.Single(v => v.CollectionId.Equals(CollectionId2));
                var collection3 = channel3.Collections.Single(v => v.CollectionId.Equals(CollectionId3));
        ...
        private static void ConfigureCollection(Collection collection)
        {
            collection.Name = Name;
            collection.QueueExclusiveLowerBound = QueueExclusiveLowerBound;
        }
