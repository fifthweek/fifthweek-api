namespace Fifthweek.Api.Identity.Membership
{
    ...
    {
        private readonly HashSet<string> reservedUsernames = new HashSet<string> { "static", "bower_components", "is", "features", "about", "help", "support", "sign-in", "register", "user", "creator" };
