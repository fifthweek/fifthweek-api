...
namespace Dexter.Api.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            IdentityUser user = await this.repository.FindAsync(new UserLoginInfo(externalLogin.LoginProvider, externalLogin.ProviderKey));
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            IdentityUser user = await this.repository.FindAsync(new UserLoginInfo(model.Provider, verifiedAccessToken.user_id));
            ...
            IdentityResult result = await this.repository.CreateAsync(user);
            if (!result.Succeeded)
            {
        ...
        public async Task<IHttpActionResult> ObtainLocalAccessToken(string provider, string externalAccessToken)
        {
            ...
            IdentityUser user = await this.repository.FindAsync(new UserLoginInfo(provider, verifiedAccessToken.user_id));
        ...
        private async Task<ParsedExternalAccessToken> VerifyExternalAccessToken(string provider, string accessToken)
        {
            ...
            if (provider == "Facebook")
            {
                ...
                var appToken = "561913473930746|O1q3gr_5LfSgVyJy4aR1eWH0nEk";
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                if (provider == "Facebook")
                {
                    ...
                    if (!string.Equals(Startup.FacebookAuthenticationOptions.AppId, parsedToken.app_id, StringComparison.OrdinalIgnoreCase))
                    {
                        return null;
                    }
                }
