namespace Fifthweek.Api.Posts.Tests.Commands
{
    ...
    public class ReviseImageCommandHandlerTests : PersistenceTestsBase
    {
        ...
        private static readonly ReviseImageCommand Command = new ReviseImageCommand(Requester, PostId, CollectionId, FileId, Comment);
        ...
        {
            await this.target.HandleAsync(new ReviseImageCommand(Requester.Unauthenticated, PostId, CollectionId, FileId, Comment));
        }
