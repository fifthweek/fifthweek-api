namespace Fifthweek.Api.Posts.Tests.Commands
{
    ...
    public class PostFileCommandHandlerTests
    {
        ...
        private static readonly PostToChannelCommand Command = new PostToChannelCommand(Requester, PostId, QueueId, FileId, Comment, ScheduleDate, IsQueued);
        ...
        {
            await this.target.HandleAsync(new PostToChannelCommand(Requester.Unauthenticated, PostId, QueueId, FileId, Comment, ScheduleDate, IsQueued));
        }
        ...
        public async Task WhenAllowedToPost_ItShouldPostToCollection()
        {
            this.postToCollectionDbStatement.Setup(
                _ => _.ExecuteAsync(PostId, QueueId, Comment, ScheduleDate, IsQueued, FileId, false, It.IsAny<DateTime>()))
