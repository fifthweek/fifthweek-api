namespace Fifthweek.Api.Posts.Tests.Commands
{
    ...
    public class CommentOnPostCommandHandlerTests
    {
        ...
        {
            this.postSecurity.Setup(v => v.AssertCommentAllowedAsync(UserId, PostId, Timestamp))
        ...
        {
            this.postSecurity.Setup(v => v.AssertCommentAllowedAsync(UserId, PostId, Timestamp)).Returns(Task.FromResult(0));
