namespace Fifthweek.Api.Posts.Tests
{
    ...
    [TestClass]
    public class LikePostDbStatementTests : PersistenceTestsBase
    {
        ...
        private LikePostDbStatement target;
        ...
        {
            this.target = new LikePostDbStatement(connectionFactory);
        }
        ...
        {
            await this.target.ExecuteAsync(null, PostId, Timestamp);
        }
        ...
        {
            await this.target.ExecuteAsync(UserId, null, Timestamp);
        }
        ...
        public async Task ItShouldBeIdempotent()
        {
            await this.DatabaseTestAsync(async testDatabase =>
            {
                ...
                await this.target.ExecuteAsync(UserId, PostId, Timestamp);
